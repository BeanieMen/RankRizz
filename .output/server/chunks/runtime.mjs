...
import fs$1, { promises, existsSync } from 'fs';
import path$1, { dirname as dirname$1, resolve as resolve$1, join } from 'path';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9100f397-23ff-48c3-95a5-a0f05f5d96a9",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/aj/rankrizz/.data/kv"}));
...
const _UserDatabase = class _UserDatabase {
  constructor() {
  ...
  static async getInstance() {
    if (!_UserDatabase.instance) {
      _UserDatabase.instance = new _UserDatabase();
      try {
        const sql = await fs.readFile("./public/db/model.sql", "utf-8");
        const tables = sql.split(";").filter((command) => command.trim());
        for (const table of tables) {
          await _UserDatabase.instance.db.run(table);
        }
      } catch (error) {
    ...
    return _UserDatabase.instance;
  }
  async createUser(id, username, passKey) {
    if (await this.getUserViaId(id))
      return null;
    const query = `
  ...
  async createStar(imageId, starRating) {
    const query = `
  ...
  async getTotalStarsCount(imageId) {
    const query = `
      SELECT COUNT(*) as count FROM Stars
      WHERE imageId = ?;
    `;
    const result = await this.db.get(query, imageId);
    return (result == null ? void 0 : result.count) || 0;
  }
  async getAverageStarRating(imageId) {
    const query = `
      SELECT AVG(starRating) as average FROM Stars
      WHERE imageId = ?;
    `;
    const result = await this.db.get(query, imageId);
    return (result == null ? void 0 : result.average) || 0;
  }
  async addImage(userId, id) {
    const query = `
  ...
  async getRandomImageIds(fetchedUserIds) {
    const userQuery = `
  ...
  async addIpLookup(ipAddress, userId) {
    const query = `
  ...
  async getIpLookupByIpAddress(ipAddress) {
    const query = `
  ...
  async addRatingLookup(ipAddress, imageId) {
    const query = `
  ...
  async upsertRatingLookup(ipAddress, imageId, commented, starRated) {
    const query = `
      INSERT INTO RatingLookup (ipAddress, imageId, commented, starRated)
      VALUES (?, ?, ?, ?)
...
__publicField(_UserDatabase, "instance");
let UserDatabase = _UserDatabase;
function generateRandomString() {
  return require$$1.randomBytes(10).toString("hex");
}

config$1();
const cronJob0 = defineCronHandler(
  () => process.env.DELETION_TIME,
  async () => {
    const db = await UserDatabase.getInstance();
    const directoryPath = path$1.resolve(process.cwd(), "public/user-photos");
    try {
      const items = fs$1.readdirSync(directoryPath, { withFileTypes: true });
      const folders = items.filter((item) => item.isDirectory());
      folders.forEach(async (folder) => {
        await db.deleteImages(folder.name);
        const folderPath = path$1.join(directoryPath, folder.name);
        fs$1.rmSync(folderPath, { recursive: true, force: true });
...
const _UJrFBuJAgp = defineNitroPlugin((nitro) => {
  const cronStack = createCronHandler({
    cronJob0
  }, { "jobsDir": "cron", "runOnInit": false, "timeZone": "Asia/Kolkata" });
...
const _TW3Uiru7uS = (function(nitro) {
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  setResponseStatus$1(event, errorObject.statusCode !== 200 && errorObject.statusCode || 500, errorObject.statusMessage);
  ...
  setResponseStatus$1(event, res.status && res.status !== 200 ? res.status : void 0, res.statusText);
...
const assets = {
  "/example.jpg": {
    "type": "image/jpeg",
    "etag": "\"1bd5-s0/zLT8ArN7kn9A4LBPjVeGTXXs\"",
    "mtime": "2024-08-16T08:45:48.958Z",
    "size": 7125,
  ...
  "/db/model.sql": {
    ...
    "etag": "\"418-WtW7EfA5OJiIWCXWJv/7aF4POCA\"",
    "mtime": "2024-08-16T08:45:48.958Z",
    "size": 1048,
    "path": "../public/db/model.sql"
  },
  "/_nuxt/BPDisUHu.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1221-hX/MfgsJ5CQg86RozFNSIcksIe4\"",
    "mtime": "2024-08-16T08:45:48.952Z",
    "size": 4641,
    "path": "../public/_nuxt/BPDisUHu.js"
  },
  "/_nuxt/BT6-juNc.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1132-nSSb3EqJA5ryHUYI149TuWF4Yig\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 4402,
    "path": "../public/_nuxt/BT6-juNc.js"
  },
  "/_nuxt/Bl2m163w.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"ab3-+MpjIXTMEbOJAc4WGfM+o49A3GA\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 2739,
    "path": "../public/_nuxt/Bl2m163w.js"
  },
  "/_nuxt/BvoW2bpS.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"393-8+S8eK+8nTJll9kCLoe8O8SqIUg\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 915,
    "path": "../public/_nuxt/BvoW2bpS.js"
  },
  "/_nuxt/CFiBINGE.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"572e-fGINED/KajDItD0yNokxgaD1gz0\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 22318,
    "path": "../public/_nuxt/CFiBINGE.js"
  },
  "/_nuxt/CtvG9C47.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3b9ce-2Nf8kuHWDEKqIRsrrTcGG73IRgg\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 244174,
    "path": "../public/_nuxt/CtvG9C47.js"
  },
  "/_nuxt/DCe-wiBY.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"10e7-eakh/3pmH5pvx8q4LM+YL0JWstQ\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 4327,
    "path": "../public/_nuxt/DCe-wiBY.js"
  },
  "/_nuxt/FopuVYF4.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1d4-e4Dnw68aDRnTHFRaXtS0oaJNdak\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 468,
    "path": "../public/_nuxt/FopuVYF4.js"
  },
  "/_nuxt/LHnzuzPt.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"c0a-prBMvencexfwayiD1jKB5b2tnb4\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 3082,
    "path": "../public/_nuxt/LHnzuzPt.js"
  },
  "/_nuxt/NuxtRating.DgkaslFl.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"2b6-VokJm/om2b7ycaStXGS4LgKO6HU\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 694,
    "path": "../public/_nuxt/NuxtRating.DgkaslFl.css"
  },
  "/_nuxt/entry.DN0gqZOu.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"24-HPnzAaGhorY8azOV5RZ7Bjjt1Zc\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 36,
    "path": "../public/_nuxt/entry.DN0gqZOu.css"
  },
  "/_nuxt/error-404.byaD8-1f.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"de4-KAiJR73c+jas/xe7mdKhnRjJXPA\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 3556,
    "path": "../public/_nuxt/error-404.byaD8-1f.css"
  },
  "/_nuxt/error-500.Mk_ildiU.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"75c-w10Io0JeEVlLLO4FHx+MPMiCMps\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 1884,
    "path": "../public/_nuxt/error-500.Mk_ildiU.css"
  },
  "/_nuxt/tQuvmLwq.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"a1a-MqfvpMofaMhayxbUJUSS+AZV0MU\"",
    "mtime": "2024-08-16T08:45:48.955Z",
    "size": 2586,
    "path": "../public/_nuxt/tQuvmLwq.js"
  },
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-b7EsQFt0BHaslV5BfkHwXqthAMI\"",
    "mtime": "2024-08-16T08:45:48.938Z",
    "size": 71,
    "path": "../public/_nuxt/builds/latest.json"
  },
  "/user-photos/625927084e38ffa63acc/id_e00ae0a6d0641dacf074.webp": {
    "type": "image/webp",
    "etag": "\"1fd0-AHK8N+mexUElI/QOANt6J2aVHwg\"",
    "mtime": "2024-08-16T08:45:48.958Z",
    "size": 8144,
    "path": "../public/user-photos/625927084e38ffa63acc/id_e00ae0a6d0641dacf074.webp"
  },
  "/_nuxt/builds/meta/9100f397-23ff-48c3-95a5-a0f05f5d96a9.json": {
    "type": "application/json",
    "etag": "\"8b-5aTTgpMD0+uCBZ0g/+9KDiKKCx4\"",
    "mtime": "2024-08-16T08:45:48.935Z",
    "size": 139,
    "path": "../public/_nuxt/builds/meta/9100f397-23ff-48c3-95a5-a0f05f5d96a9.json"
  }
};
...
const _HHuiVa = defineCachedEventHandler(async (ctx) => {
...
const _lazy_qWTjKR = () => import('./routes/api/generate-account.mjs');
const _lazy_ZwM3Ug = () => import('./routes/api/random.mjs');
const _lazy_K4LQ02 = () => import('./routes/api/recieve-rating.mjs');
const _lazy_0VjG2v = () => import('./routes/api/upload.mjs');
const _lazy_xmzI5m = () => import('./routes/api/user/_pass_.mjs');
const _lazy_i8rq5D = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/api/generate-account', handler: _lazy_qWTjKR, lazy: true, middleware: false, method: undefined },
  { route: '/api/random', handler: _lazy_ZwM3Ug, lazy: true, middleware: false, method: undefined },
  { route: '/api/recieve-rating', handler: _lazy_K4LQ02, lazy: true, middleware: false, method: undefined },
  { route: '/api/upload', handler: _lazy_0VjG2v, lazy: true, middleware: false, method: undefined },
  { route: '/api/user/:pass', handler: _lazy_xmzI5m, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_i8rq5D, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _HHuiVa, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_i8rq5D, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, isEqual as A, createHooks as B, createError as C, hasProtocol as D, joinURL as E, withQuery as F, isScriptProtocol as G, sanitizeStatusCode as H, withTrailingSlash as I, withoutTrailingSlash as J, toRouteMatcher as K, createRouter$1 as L, parse as M, destr as N, setCookie as O, getCookie as P, deleteCookie as Q, nodeServer as R, UserDatabase as U, generateRandomString as a, getQuery as b, readFormData as c, defineEventHandler as d, getRouterParam as e, eventHandler as f, getRequestHeader as g, setResponseHeader as h, send as i, getResponseStatus as j, setResponseStatus$1 as k, setResponseHeaders as l, joinRelativeURL as m, useRuntimeConfig as n, getQuery$2 as o, createError$2 as p, getRouteRules as q, readBody as r, setResponseStatus as s, getResponseStatusText as t, useNitroApp as u, defuFn as v, defu as w, klona as x, createDefu as y, parseQuery as z };
