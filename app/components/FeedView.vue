        ...
        >
          ...
          <template #indicator="{ onClick, page, active }">
            <UButton
              ...
              @click="handleIndicatorClick(page, onClick)"
            />
          </template>
        </UCarousel>
      </div>
      ...
      <div class="flex flex-col space-y-6 w-full md:pl-8">
        <div class="text-center">
          <h1 class="text-2xl md:text-3xl font-bold mb-4">
            ...
            <h2 class="text-md md:text-lg font-semibold mt-2">
              Rating image number: {{ pageRef }}
            </h2>
          </h1>
        </div>
        ...
        <div class="w-full mb-6">
          <h2 class="text-lg md:text-xl font-semibold mb-2 text-center">
            Leave a comment:
          </h2>
          <textarea
            v-model="comment"
